...
SELECT a1.first_name || ' ' || a1.last_name AS "Actor Name" FROM actor a1 JOIN (
    ...
    WHERE a2.first_name = 'RUSSELL' AND a2.last_name = 'BACALL') cube USING (actor_id)
ORDER BY 1;
